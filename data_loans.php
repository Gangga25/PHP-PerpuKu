...
<head>
  ...
  <title>PerpusKu | Data Pinjaman Buku</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Data Pinjaman Buku</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="btn-group">
                              <button type="button" class="btn btn-info btn-xs">
                                <a class="text-light" href="input_loans.php?id=<?php echo $row['id'] ?>">
                                  Edit
                                </a>
                              </button>
